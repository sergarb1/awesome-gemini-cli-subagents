<div align="center">
    <strong>The awesome collection of Gemini CLI programming agents.</strong>
</div>

<div align="center">
    
[![Awesome](https://awesome.re/badge.svg)](https://awesome.re)
[![Last Update](https://img.shields.io/github/last-commit/sergarb1/awesome-gemini-cli-subagents?label=Last%20update&style=flat-square)](https://github.com/sergarb1/awesome-gemini-cli-subagents)
[![GitHub forks](https://img.shields.io/github/forks/sergarb1/awesome-gemini-cli-subagents?style=social)](https://github.com/sergarb1/awesome-gemini-cli-subagents/network/members)
    
</div>

# Awesome Gemini CLI Programming Agents 

## What is this?

This repository is a curated collection of **Gemini CLI subagents** specifically designed for **programming, software engineering, and technical development tasks**. 

The repository is structured to be "Plug & Play". Simply clone it or copy the agents you need.

## 🚀 Installation & Usage (Plug & Play)

The easiest way to use these agents is to clone this repository directly into your project's `.gemini` folder:

```bash
# Inside your project's root directory
git clone https://github.com/sergarb1/awesome-gemini-cli-subagents .gemini
```

Gemini CLI will automatically detect all agents in the `agents/` folder.

If you only want specific agents, you can just copy the `.md` files from the [**agents/**](agents/) directory to your project's `.gemini/agents/` folder.

## 🤖 Available Agents

All agents are located in the [**agents/**](agents/) directory.
...
- [**windows-infra-admin**](agents/windows-infra-admin.md) - AD, DNS, DHCP, and GPO automation specialist

### Quality & Security
- [**accessibility-tester**](agents/accessibility-tester.md) - A11y compliance expert
- [**ad-security-reviewer**](agents/ad-security-reviewer.md) - AD security and GPO audit specialist
...
### Meta & Orchestration
- [**agent-installer**](agents/agent-installer.md) - Browse and install agents via GitHub
...
We welcome contributions! Simply add your agent `.md` file to the `agents/` folder and update this README.
